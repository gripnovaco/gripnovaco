      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {posts.map((post, i) => (
          <Link key={post.slug} to="/blog/$slug" params={{ slug: post.slug }}
            ...
            <div className={`aspect-[16/9] bg-gradient-to-br ${["from-sky-100 to-blue-200","from-blue-100 to-indigo-200","from-cyan-100 to-sky-200","from-indigo-100 to-blue-200","from-sky-50 to-blue-100","from-blue-50 to-cyan-100"][i % 6]}`} />
            <div className="p-5">
